...
const usersData = [
    ...
    { id: 5, name: 'Nikhil Talmale', status: 'Active', Designation: 'Java Developer', imageAddress: p5 },
    { id: 6, name: 'Shadab Shaikh', status: 'Active', Designation: 'DotNet Developer', imageAddress: p6 },
                ...
                <div className='flex items-center pl-2 bg-gray-200 text-purple-800 border-gray-300 rounded w-auto'>
                    ...
                    <div className='hidden md:flex'>
                        <input
                            ...
                            className="p-2  ml-auto bg-gray-200 outline-none w-auto"
                        />
                    </div>
                </div>
            </div>
